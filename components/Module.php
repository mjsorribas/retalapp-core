...
class Module extends CWebModule
{
	...
	*/
	public function menuItems()
	{
		...
		return array(
            array('label'=>$this->labelMenu!==null?$this->labelMenu:Yii::t('app',ucfirst($this->id)), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('/'.$this->id.'/back'),'visible'=>Yii::app()->getModule('users')->check('root')),
       );
	}
	...
	{
		if(Yii::app()->getModule('users')->check($this->getAllowPermissoms()))
