...
<div class="row">
    ...
    <div class="col-lg-7">
        <div class="panel panel-default">
          ...
          <div class="panel-heading"><b><?php echo CHtml::encode($model->getAttributeLabel('users_location_countries_id')); ?>:</b></div>
          <div class="panel-body">
            <p><?php echo $model->users_location_countries_id;?></p>
          </div>
