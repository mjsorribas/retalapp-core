...
class FollowersController extends CmsController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UsersFollowers']))
		{
			$model->attributes=$_POST['UsersFollowers'];
	 ...
	 * @return UsersFollowers the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UsersFollowers::model()->findByPk($id);
		if($model===null)
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='users-followers-form')
		{
			$result=array();
