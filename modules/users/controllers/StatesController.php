...
class StatesController extends CmsController
{
	...
	public $title='<i class="fa fa-map-marker"></i> States';
	public $subTitle='Admin States';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UsersLocationStates']))
		{
			$model->attributes=$_POST['UsersLocationStates'];
			...
			$last=UsersLocationStates::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new UsersLocationStates('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsersLocationStates']))
			$model->attributes=$_GET['UsersLocationStates'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=UsersLocationStates::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('UsersLocationStates.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('States.xls',$content);
	}
	 ...
	 * @return UsersLocationStates the loaded model
	 ...
	 * @param UsersLocationStates $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='users-location-states-form')
		{
