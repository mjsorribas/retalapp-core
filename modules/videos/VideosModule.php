...
class VideosModule extends Module
{
	public function init()
	{
		...
		defined('VIDEOS_ID') or define('VIDEOS_ID',$this->id);
	...
	*/
    ...
    {
        return array(
        	array('label'=>Yii::t('app','Vídeos'), 'icon'=>'fa fa-youtube-play', 'url'=>array('#'), 'items'=>array(
            	array('label'=>Yii::t('app','Vídeos'), 'icon'=>'fa fa-angle-double-right', 'url'=>array('/'.$this->id.'/videos/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Videos'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Videos'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.VIDEOS_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.VIDEOS_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(VIDEOS_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'videos-1'=>'landingVideos',
		);
    }

	public function landingVideos($item=null)
	{
