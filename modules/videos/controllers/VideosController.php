...
class VideosController extends CmsController
{
	/////////////////////////////
	...
	public $title='<i class="fa fa-youtube-play"></i> Vídeos';
	public $subTitle='Admin Vídeos';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['VideosVideos']))
		{
			$model->attributes=$_POST['VideosVideos'];
			...
			$last=VideosVideos::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new VideosVideos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['VideosVideos']))
			$model->attributes=$_GET['VideosVideos'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=VideosVideos::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('VideosVideos.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Vídeos.xls',$content);
	}
	 ...
	 * @return VideosVideos the loaded model
	 ...
	 * @param VideosVideos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='videos-videos-form')
		{
