...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'filter'=>$model,
        ...
        $('#videos-videos-grid tbody').sortable({ opacity: 0.00001 });
        $('#videos-videos-grid tbody').sortable({
            update: function() {
                var that = $(this);
	...
	'columns'=>array(
		...
		array(
			'name'=>'descripcion',
			'type'=>'raw',
			'value'=>'"<span class=\"text-muted\">".substr(strip_tags($data->descripcion),0,50)."...</span>"',
		),
		/*
		/*array(
			'class'=>'CButtonColumn',
	        ...
	        if(result) {
	            $.ajax({
	                ...
	                success:function (data) {
	                    $.fn.yiiGridView.update('videos-videos-grid');
