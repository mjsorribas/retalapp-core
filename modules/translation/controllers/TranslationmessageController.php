...
class TranslationmessageController extends CmsController
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new TranslationMessage;

		if(isset($_POST['TranslationMessage']))
		{
			$model->attributes=$_POST['TranslationMessage'];
			$model->id=$_GET['id_id']; // en curso
			if($model->save())
			{
	 ...
	 * @return TranslationMessage the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TranslationMessage::model()->findByPk($id);
		if($model===null)
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='translation-message-form')
		{
			$result=array();
