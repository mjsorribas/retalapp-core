...
Yii::import('core.modules.gii.models.base.BaseGiiModels');
Yii::import('core.modules.gii.models.GiiModels');
class ModelGenerator extends CCodeGenerator
{
	...
	protected function prepare()
	{
		...
		if(isset($_GET['model_history']))
		{
			$historySelect=GiiModels::model()->findByPk($_GET['model_history']);
