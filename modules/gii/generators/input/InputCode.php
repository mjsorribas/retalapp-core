...
class InputCode extends CCodeModel
{
	public $model;
	public $viewPath='application.views';
	public $viewName='my_input_name';
	public $template='dropdown';
	public $justPreview=true;
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			array('model, viewName, moduleName', 'required'),
...
EOD;
		$code="<?php\n".$this->render($this->templatePath.'/input.php');
	...
	public function prepare()
	{
		...
		$this->files[]=new CCodeFile(
			...
			$this->render($templatePath.'/input.php')
		);
	}
