...
class PortfolioModule extends Module
{
	...
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.PORTFOLIO_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.PORTFOLIO_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(PORTFOLIO_ID.'.views.page.'.$view,$params,true);
	}
