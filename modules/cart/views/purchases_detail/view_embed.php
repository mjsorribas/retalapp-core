...
<table class="table">
	...
	<tr>
		...
		<td class="data-item-<?php echo $i?>">$<?php echo r('#format')->money($data->unit_value)?></td>
		<td class="data-item-<?php echo $i?>-total">$<?php echo r('#format')->money(($data->unit_value)*$data->quantity)?></td>
	</tr>

	<?php $subTotal+=(($data->unit_value)*$data->quantity)?>
	<?php endforeach;?>
...
<table class="table">
	...
	<tr>
		...
		<td class="text-right" style="width:120px">$<?php echo r('#format')->money($totalTax)?></td>
	</tr>
	-->
	<tr>
		<td></td>
