...
class Purchases_detailController extends CmsController
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new CartShoppingDetail;

		if(isset($_POST['CartShoppingDetail']))
		{
			$model->attributes=$_POST['CartShoppingDetail'];
			$model->cart_shoping_header_id=$_GET['cart_shoping_header_id']; // en curso
	 ...
	 * @return CartShoppingDetail the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=CartShoppingDetail::model()->findByPk($id);
		if($model===null)
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='cart-shopping-detail-form')
		{
			$result=array();
