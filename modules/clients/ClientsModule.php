...
class ClientsModule extends Module
{
	public function init()
	{
		...
		defined('CLIENTS_ID') or define('CLIENTS_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Clients'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Clients'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
	...
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.CLIENTS_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.CLIENTS_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(CLIENTS_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'clients-1'=>'landingClients',
		);
    }

	public function landingClients($item=null)
	{
