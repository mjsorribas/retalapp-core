 ...
 */
class UsersUsers extends BaseUsersUsers
{
	public $conditions=0;
	public $newPassword;
	...
	public function validateConfirm($attribute, $params)
	{
		if($this->confirmPassword!==$this->password)
			$this->addError('confirmPassword',Yii::t('app','Please confirm your password'));
	}
