...
class CountriesController extends CmsController
{
	...
	public $title='<i class="fa fa-globe"></i> Countries';
	public $subTitle='Admin Countries';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UsersLocationCountries']))
		{
			$model->attributes=$_POST['UsersLocationCountries'];
			...
			$last=UsersLocationCountries::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new UsersLocationCountries('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsersLocationCountries']))
			$model->attributes=$_GET['UsersLocationCountries'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=UsersLocationCountries::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('UsersLocationCountries.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Countries.xls',$content);
	}
	 ...
	 * @return UsersLocationCountries the loaded model
	 ...
	 * @param UsersLocationCountries $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='users-location-countries-form')
		{
