...
class CitiesController extends CmsController
{
	...
	public $title='<i class="fa fa-university"></i> Cities';
	public $subTitle='Admin Cities';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UsersLocationCities']))
		{
			$model->attributes=$_POST['UsersLocationCities'];
			...
			$last=UsersLocationCities::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new UsersLocationCities('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsersLocationCities']))
			$model->attributes=$_GET['UsersLocationCities'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=UsersLocationCities::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('UsersLocationCities.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Cities.xls',$content);
	}
	 ...
	 * @return UsersLocationCities the loaded model
	 ...
	 * @param UsersLocationCities $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='users-location-cities-form')
		{
