...
class FollowingController extends CmsController
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new UsersFollowing;

		if(isset($_POST['UsersFollowing']))
		{
			$model->attributes=$_POST['UsersFollowing'];
			$model->users_users_id=$_GET['users_users_id']; // en curso
	 ...
	 * @return UsersFollowing the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UsersFollowing::model()->findByPk($id);
		if($model===null)
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='users-following-form')
		{
			$result=array();
