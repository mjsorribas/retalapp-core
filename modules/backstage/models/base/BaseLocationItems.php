...
/**
 * This is the model class for table "location_items".
 *
 * The followings are the available columns in table 'location_items':
 * @property integer $id
 * @property string $image
 * @property integer $orden_id
 */
class BaseLocationItems extends Model
{
	public $image_path;
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, image, orden_id', 'safe', 'on'=>'search'),
		);
	}
