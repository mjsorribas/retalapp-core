...
class TestimoniosModule extends Module
{
	public function init()
	{
		...
		defined('TESTIMONIOS_ID') or define('TESTIMONIOS_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Testimonios'), 'icon'=>'fa fa-comments', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Testimonios'), 'icon'=>'fa fa-angle-double-right', 'url'=>array('/'.$this->id.'/testimonios/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Testimonios'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Testimonios'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.TESTIMONIOS_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.TESTIMONIOS_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(TESTIMONIOS_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'testimonios-1'=>'landingTestimonios',
		);
    }

	public function landingTestimonios($item=null)
	{
