...
class TestimoniosController extends CmsController
{
	/////////////////////////////
	...
	public $title='<i class="fa fa-comments"></i> Testimonios';
	public $subTitle='Admin Testimonios';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TestimoniosTestimonios']))
		{
			$model->attributes=$_POST['TestimoniosTestimonios'];
			...
			$last=TestimoniosTestimonios::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new TestimoniosTestimonios('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TestimoniosTestimonios']))
			$model->attributes=$_GET['TestimoniosTestimonios'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=TestimoniosTestimonios::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('TestimoniosTestimonios.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Testimonios.xls',$content);
	}
	 ...
	 * @return TestimoniosTestimonios the loaded model
	 ...
	 * @param TestimoniosTestimonios $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='testimonios-testimonios-form')
		{
