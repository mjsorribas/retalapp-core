...
class PriceModule extends Module
{
	public function init()
	{
		...
		defined('PRICE_ID') or define('PRICE_ID',$this->id);
    ...
    {
        return array(
            array('label'=>Yii::t('app','Price'), 'icon'=>'fa fa-dollar', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Prices'), 'icon'=>'fa fa-dollar', 'url'=>array('/'.$this->id.'/price/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Price'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Price'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.PRICE_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.PRICE_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(PRICE_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'price-1'=>'landingPrice',
		);
    }

	public function landingPrice($item=null)
	{
