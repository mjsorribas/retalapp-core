...
/**
 * This is the model class for table "features_items".
 *
 * The followings are the available columns in table 'features_items':
 * @property integer $id
 ...
 */
class BaseFeaturesItems extends Model
{
	public $image_path;
	...
	public function rules()
	{
		...
		return array(
			array('image, title, text, orden_id', 'required'),
			...
			array('id, image, title, text, orden_id', 'safe', 'on'=>'search'),
		);
	}
