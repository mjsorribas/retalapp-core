...
class FeaturesModule extends Module
{
	public function init()
	{
		...
		defined('FEATURES_ID') or define('FEATURES_ID',$this->id);
	...
	*/
    ...
    {
        return array(
            array('label'=>Yii::t('app','Features'), 'icon'=>'fa fa-star', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Features'), 'icon'=>'fa fa-star-o', 'url'=>array('/'.$this->id.'/items/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Features'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Features'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.FEATURES_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.FEATURES_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(FEATURES_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'features-1'=>'landingFeatures',
		);
    }

	public function landingFeatures($item=null)
	{
