...
class CategoriesController extends CmsController
{
	...
	public $title='<i class="fa fa-list-ol"></i> Categories';
	public $subTitle='Admin Categories';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PortfolioCategories']))
		{
			...
			$last=PortfolioCategories::model()->findAll();
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=PortfolioCategories::model()->findByPk($datos['id']);
	 ...
	 * @return PortfolioCategories the loaded model
	 ...
	 * @param PortfolioCategories $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='portfolio-categories-form')
		{
