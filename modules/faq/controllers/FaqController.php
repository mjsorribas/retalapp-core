...
class FaqController extends CmsController
{
	/////////////////////////////
	...
	public $title='<i class="fa fa-question-circle"></i> Preguntas frecuentes';
	public $subTitle='Admin Preguntas frecuentes';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['FaqFaq']))
		{
			$model->attributes=$_POST['FaqFaq'];
			...
			$last=FaqFaq::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new FaqFaq('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FaqFaq']))
			$model->attributes=$_GET['FaqFaq'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=FaqFaq::model()->findByPk($datos['id']);
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Preguntas frecuentes.xls',$content);
	}
	 ...
	 * @return FaqFaq the loaded model
	 ...
	 * @param FaqFaq $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='faq-faq-form')
		{
