...
class FaqModule extends Module
{
	public function init()
	{
		...
		defined('FAQ_ID') or define('FAQ_ID',$this->id);
	...
	*/
    ...
    {
        return array(
            array('label'=>Yii::t('app','Faq'), 'icon'=>'fa fa-question-circle', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Preguntas frecuentes'), 'icon'=>'fa fa-angle-double-right', 'url'=>array('/'.$this->id.'/faq/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Faq'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Faq'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.FAQ_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.FAQ_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(FAQ_ID.'.views.page.'.$view,$params,true);
	}
	...
	public function landingFaq($item=null)
	{
