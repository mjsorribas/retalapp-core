...
class CustomersModule extends Module
{
	public function init()
	{
		...
		defined('CUSTOMERS_ID') or define('CUSTOMERS_ID',$this->id);
	...
	{
		return array(
            array('label'=>Yii::t('app','Customers'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Customers'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
