...
class How_workModule extends Module
{
	public function init()
	{
		...
		defined('HOW_WORK_ID') or define('HOW_WORK_ID',$this->id);
	...
	*/
    ...
    {
        return array(
            array('label'=>Yii::t('app','How_work'), 'icon'=>'fa fa-question-circle', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Main Text'), 'icon'=>'fa fa-question-circle', 'url'=>array('/'.$this->id.'/text/')),
                array('label'=>Yii::t('app','How does it work?'), 'icon'=>'fa fa-question-circle', 'url'=>array('/'.$this->id.'/howwork/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','How_work'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin How_work'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	...
	*/
    ...
    {
    	return array(
			'how_work-1'=>'landingHow_work',
		);
    }

	public function renderPartialView($view,$params=array())
    {
    	if(r()->controller->getViewFile('//'.HOW_WORK_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.HOW_WORK_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(HOW_WORK_ID.'.views.page.'.$view,$params,true);
	}
	
	public function landingHow_work($item=null)
	{
