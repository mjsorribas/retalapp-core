...
$this->breadcrumbs=array(
	...
	'Lista de How does it work? Steps',
);
 ?><div class="col-lg-12">
<section class="panel">
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'filter'=>$model,    'afterAjaxUpdate'=>"js:function(){
        $('#how-work-items-grid tbody').sortable({ opacity: 0.00001 });
        $('#how-work-items-grid tbody').sortable({
            update: function() {
                var that = $(this);
	        ...
	        if(result) {
	            $.ajax({
	                ...
	                success:function (data) {
	                    $.fn.yiiGridView.update('how-work-items-grid');
	                },
