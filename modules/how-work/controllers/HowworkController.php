...
class HowworkController extends CmsController
{
	/////////////////////////////
	...
	public $title='<i class="fa fa-question"></i> How does it work? Steps';
	public $subTitle='Admin How does it work? Steps';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['HowWorkItems']))
		{
			$model->attributes=$_POST['HowWorkItems'];
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['HowWorkItems']))
			$model->attributes=$_GET['HowWorkItems'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=HowWorkItems::model()->findByPk($datos['id']);
	 ...
	 * @return HowWorkItems the loaded model
	 ...
	 * @param HowWorkItems $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='how-work-items-form')
		{
