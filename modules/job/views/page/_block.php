        ...
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <form action="#" id="job-form">
                ...
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        <label>Resume</label>
                        <input type="text" class="form-control" placeholder="Resume" id="file" name="file">
                        <?php echo $this->widget('ext.inputs.uploader.GFrontUpload', array(
                              'name' => 'file',
                              'value' => '',
...
$(document).on('submit','#job-form',function(e) {
    ...
    var $form = $(this);
    $.ajax({
        url: '<?php echo $this->createUrl("/job/page/contactJson");?>',
        dataType: 'json', 
        type: 'post',
        data: $form.serialize(),
