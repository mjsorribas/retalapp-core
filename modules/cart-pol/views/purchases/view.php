  ...
  <div class="panel panel-default">
          ...
          <div class="panel-body">
            <p>
              ...
              <li class="list-group-item">
                <strong>Sexo:</strong>
                <p><?php echo $model->user->gender=='m'?'Masculino':'Femenino'?></p>
              </li>
              <li class="list-group-item">
                <strong>No. de identificación:</strong>
                <p><?php echo $model->user->card_identity?></p>
              </li>
              <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <p><?php echo $model->user->mobile?></p>
              </li>
              <li class="list-group-item">
                <strong>Email:</strong>
              ...
              <li class="list-group-item">
                ...
                <p><?php echo ($model->cart_shipment_data!==null and $model->cart_shipment_data->city!==null)?$model->cart_shipment_data->city->name:''?></p>
              </li>
              <li class="list-group-item">
