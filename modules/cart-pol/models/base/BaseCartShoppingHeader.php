...
class BaseCartShoppingHeader extends Model
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('datetime_go_pay, datetime_return_pay, message_return_pay', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, ref_venta, users_id, total, shipping_cost, overall_tax, cart_states_id, signature, created_at, updated_at, datetime_go_pay, datetime_return_pay, message_return_pay, code_response_pay, code2_response_pay', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'code_response_pay' => Yii::t('app','Code Response Pay'),
