...
<h4><i class="fa fa-qrcode"></i> <?php echo Yii::t('app','Detail')?> <span class="loading"></span></h4>
...
<table class="table">
	...
	<tr>
		...
		<td class="data-item-<?php echo $i?>"><?=$simbol?><?php echo number_format($row->{$modelUnitValue})?></td>
		<td class="data-item-<?php echo $i?>-total"><?=$simbol?><?php echo number_format(($row->{$modelUnitValue})*$data->quantity)?></td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td class="text-right" style="width:120px"><?=$simbol?><?php echo number_format($subTotal)?></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td class="text-right"><strong>IVA</strong></td>
		<td class="text-right" style="width:120px"><?=$simbol?><?php echo number_format($totalTax)?></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td class="text-right"><strong>ENVÍO</strong></td>
		<td class="text-right" style="width:120px"><?=$simbol?><?php echo number_format($shippingCost)?></td>
	</tr>
	<?php endif;?>
	<tr>
		<td></td>
		...
		<td class="text-right" style="width:120px"><?=$simbol?><?php echo number_format($total)?></td>
	</tr>
</table>
