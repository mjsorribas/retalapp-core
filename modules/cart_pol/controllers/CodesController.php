...
class CodesController extends CmsController
{
	/////////////////////////////
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['CartSecretCodes']))
			$model->attributes=$_GET['CartSecretCodes'];
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('CartSecretCodes.pdf');
	}
	 ...
	 * @param CartSecretCodes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cart-secret-codes-form')
		{
