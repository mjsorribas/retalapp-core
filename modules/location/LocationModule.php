...
class LocationModule extends Module
{
	public function init()
	{
		...
		defined('LOCATION_ID') or define('LOCATION_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Location'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Location'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
