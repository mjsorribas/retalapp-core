...
class ImagesController extends CmsController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShoppingImages']))
		{
			$model->attributes=$_POST['ShoppingImages'];
			...
			$last=ShoppingImages::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	 ...
	 * @return ShoppingImages the loaded model
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='shopping-images-form')
		{
			$result=array();
