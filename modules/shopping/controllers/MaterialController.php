...
class MaterialController extends CmsController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShoppingMaterial']))
		{
			$model->attributes=$_POST['ShoppingMaterial'];
			...
			$last=ShoppingMaterial::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	 ...
	 * @return ShoppingMaterial the loaded model
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='shopping-material-form')
		{
			$result=array();
