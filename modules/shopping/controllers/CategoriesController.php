...
class CategoriesController extends CmsController
{
	...
	public $title='<i class="fa fa-list-ol"></i> Categorías';
	public $subTitle='Admin Categorías';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShoppingCategories']))
		{
			$model->attributes=$_POST['ShoppingCategories'];
			...
			$last=ShoppingCategories::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new ShoppingCategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ShoppingCategories']))
			$model->attributes=$_GET['ShoppingCategories'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=ShoppingCategories::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('ShoppingCategories.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Categorías.xls',$content);
	}
	 ...
	 * @return ShoppingCategories the loaded model
	 ...
	 * @param ShoppingCategories $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='shopping-categories-form')
		{
