...
class FeaturesController extends CmsController
{
	...
	public $title='<i class="fa fa-rocket"></i> Beneficios';
	public $subTitle='Admin Beneficios';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShoppingFeatures']))
		{
			$model->attributes=$_POST['ShoppingFeatures'];
			...
			$last=ShoppingFeatures::model()->findAll(array('order'=>'orden_id'));
			$i=2;
	...
	{
		$model=new ShoppingFeatures('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ShoppingFeatures']))
			$model->attributes=$_GET['ShoppingFeatures'];
	...
	public function actionOrder()
	{
        ...
        for($i = 0 ; $i < $cant ; $i++){
	        ...
	        $ini = $ini + 1 ;
	        $model=ShoppingFeatures::model()->findByPk($datos['id']);
	...
	public function actionPdf($id)
	{
		...
		$html2pdf->Output('ShoppingFeatures.pdf');
	}
	...
	public function actionExcel()
	{
		...
		r()->request->sendFile('Beneficios.xls',$content);
	}
	 ...
	 * @return ShoppingFeatures the loaded model
	 ...
	 * @param ShoppingFeatures $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='shopping-features-form')
		{
