...
class VideosController extends CmsController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShoppingVideos']))
		{
			$model->attributes=$_POST['ShoppingVideos'];
			...
			// $last=ShoppingVideos::model()->findAll(array('order'=>'orden_id'));
			// $i=2;
	 ...
	 * @return ShoppingVideos the loaded model
	...
	{
		if($model->getErrors()!==array() and isset($_POST['ajax']) and $_POST['ajax']==='shopping-videos-form')
		{
			$result=array();
