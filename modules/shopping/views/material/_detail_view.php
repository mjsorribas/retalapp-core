<div class="panel panel-default mtl">
    ...
    <div class="panel-body">
        <p id="ShoppingMaterial_id_label"></p>
    </div>
	<div class="panel-heading"><?php echo CHtml::encode($model->getAttributeLabel('nombre')); ?></div>
    <div class="panel-body">
        <p id="ShoppingMaterial_nombre_label"></p>
    </div>
	<div class="panel-heading"><?php echo CHtml::encode($model->getAttributeLabel('orden_id')); ?></div>
    <div class="panel-body">
        <p id="ShoppingMaterial_orden_id_label"></p>
    </div>
	<div class="panel-heading"><?php echo CHtml::encode($model->getAttributeLabel('shopping_items_id')); ?></div>
    <div class="panel-body">
        <p id="ShoppingMaterial_shopping_items_id_label"></p>
    </div>
	</div>
