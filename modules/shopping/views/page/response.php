...
if($this->module->typePlataform=='payu') {
  $ApiKey=$this->module->ApiKey;/////llave de usuario de pruebas 2 6u39nqhq8ftd0hlvnjfs66eh8c
...
<?php if($this->module->typePlataform=='payu'):?>
<?php if($_REQUEST['transactionState'] == 4 && $_REQUEST['polResponseCode'] == 1):?>
<tr>
<td colspan="2">
<a href="<?php echo CHtml::normalizeUrl($this->module->returnUrlAfterPay)?>" style="padding-left: 24px;" id="button-continuar" class="btn-irapagar submit-bt grl-bt fr tr">Continuar</a>
</td>
</tr>
<?php endif;?>
<?php else:?>
