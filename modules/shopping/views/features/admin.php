...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'filter'=>$model,
        ...
        $('#shopping-features-grid tbody').sortable({ opacity: 0.00001 });
        $('#shopping-features-grid tbody').sortable({
            update: function() {
                var that = $(this);
	        ...
	        if(result) {
	            $.ajax({
	                ...
	                success:function (data) {
	                    $.fn.yiiGridView.update('shopping-features-grid');
