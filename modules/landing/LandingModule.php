...
class LandingModule extends Module
{
	...
	*/
    ...
    {
        return array(
            array('label'=>Yii::t('app','Landing'), 'icon'=>'fa fa-desktop', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Pages'), 'icon'=>'fa fa-desktop', 'url'=>array('/'.$this->id.'/pages/admin')),
	...
	*/
    ...
    {
    	return array(
			'landing-1'=>'landingLanding',
		);
    }

	public function landingLanding($item=null)
	{
