...
class NewsletterModule extends Module
{
	public function init()
	{
		...
		defined('NEWSLETTER_ID') or define('NEWSLETTER_ID',$this->id);
    ...
    {
        return array(
            array('label'=>Yii::t('app','Newsletter'), 'icon'=>'fa fa-envelope', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Boletín'), 'icon'=>'fa fa-envelope', 'url'=>array('/'.$this->id.'/newsletter/')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Newsletter'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Newsletter'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.NEWSLETTER_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.NEWSLETTER_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(NEWSLETTER_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'newsletter-1'=>'landingNewsletter',
		);
    }

	public function landingNewsletter($item=null)
	{
