...
class EquipoModule extends Module
{
	public function init()
	{
		...
		defined('EQUIPO_ID') or define('EQUIPO_ID',$this->id);
	...
	*/
    ...
    {
        return array(
            array('label'=>Yii::t('app','Equipo'), 'icon'=>'fa fa-users', 'url'=>array('#'), 'items'=>array(
                array('label'=>Yii::t('app','Nuestro equipo'), 'icon'=>'fa fa-angle-double-right', 'url'=>array('/'.$this->id.'/equipo/admin')),
	...
	{
		return array(
            array('label'=>Yii::t('app','Equipo'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Equipo'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
            	// ... Put here more sub-menues like this 
            )),
       );
	}
	*/
    ...
    {
    	if(r()->controller->getViewFile('//'.EQUIPO_ID.'/page/'.$view)!==false)
			return r()->controller->renderPartial('//'.EQUIPO_ID.'/page/'.$view,$params,true);
		return r()->controller->renderPartial(EQUIPO_ID.'.views.page.'.$view,$params,true);
	}
    ...
    {
    	return array(
			'equipo-1'=>'landingEquipo',
		);
    }

	public function landingEquipo($item=null)
	{
