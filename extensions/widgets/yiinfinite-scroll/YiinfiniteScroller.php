...
class YiinfiniteScroller extends CBasePager {
    ...
    public $successCallback = 'function(arrayOfNewElems){ console.log(arrayOfNewElems);}';
    ...
    public function registerClientScript() {
        $url = CHtml::asset(Yii::getPathOfAlias('ext.widgets.yiinfinite-scroll.assets').'/jquery.infinitescroll.min.js');
    ...
    private function createInfiniteScrollScript() {
        Yii::app()->clientScript->registerScript(
            uniqid(),
            "$('{$this->contentSelector}').infinitescroll(".$this->buildInifiniteScrollOptions().','.$this->successCallback);
    }
