 ...
 * @since 1.0
 */
class GRadio extends CInputWidget
{
	...
	public function run()
	{
		...
		$this->htmlOptions=array_merge($this->htmlOptions,array(
			...
			'template'=>'<a href="#" style="padding:0" class="list-group-item">{beginLabel} 
				<div class="col-lg-2">{input}</div>
				<div class="col-lg-10">{labelTitle}</div>
				{endLabel}</a>',
			'separator'=>'',
		));
		...
		echo '<div class="list-group">'.Chtml::activeRadioButtonList($this->model,$this->attribute,
